...
FPS = 30 # frames per second, the general speed of a program
...
GAPSIZE = 10 # size of gap between boxes and pixels
...
def main():
    ...
    mousex = 0 # used to store the x coordinate of mouse event
    mousey = 0 # used to store the y coordinate of mouse event
    ...
    while True: # main game loop
        ...
        if boxx != None and boxy != None:
            # The moust is currently over a box.
...
def gameWonAnimation(board):
    ...
    for i in range(13):
        color1,color2 = color2,color1 #color swaps
